...
availableItems = { -- [ItemID] = {Név, Leírás, Súly, Stackelhető, Fegyver ID, Töltény item ID, Eldobható, Model, RotX, RotY, RotZ, Z offset}
	...
	[34] = {"Halloween P90 [LIMITÁLT]", "Limitált kiadás", 0, false, 29, -1},
	...
	[63] = {"Halloween AK-47 [LIMITÁLT]", "Limitált kiadás", 0, false, 30, -1},
	[64] = {"Halloween Deagle [LIMITÁLT]", "Limitált kiadás", 0, false, 24, -1},
	[65] = {"Névcédula", "Itemek elnevezésére alkalmas tárgy", false, -1, -1},
	[66] = {"Halloween M4 [LIMITÁLT]", "Limitált kiadás", 0, false, 31, -1},
}
