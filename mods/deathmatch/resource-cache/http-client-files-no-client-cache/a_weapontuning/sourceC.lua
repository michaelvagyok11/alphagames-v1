	...
	function ()
		for TextureName, ShouldBeLoaded in pairs(TexturesToBeLoaded) do
			if ShouldBeLoaded then
				local FilePath = UnlockFile("files/spaz/" .. TextureName .. ".alphaGames", FileKeys[TextureName])

				if fileExists("files/spaz/" .. TextureName .. ".alphaGames") then
					local TextureElement = dxCreateTexture(FilePath, "dxt1")
					print(TextureElement)
...
local availablePaintjobs = {
	[30] = {
		...
		[10] = dxCreateTexture("files/ak/halloweenak.png", "dxt1"), -- halloween
	...
	[24] = {
		...
		[5] = dxCreateTexture("files/deagle/halloween_deagle.png", "dxt1"), -- halloween
	},
	[29] = {
	...
	[31] = {
		...
		[9] = dxCreateTexture("files/m4/9.png", "dxt1"), -- thunder m4
		[10] = dxCreateTexture("files/m4/10.png", "dxt1"), -- stratched m4
		[11] = dxCreateTexture("files/m4/11.png", "dxt1"),
		[12] = dxCreateTexture("files/m4/12.png", "dxt1"),
	},
	[27] = { -- Spaz
		[1] = dxCreateTexture(UnlockFile("files/spaz/dragon.alphaGames", FileKeys["dragon"]), "dxt1"),
		[2] = dxCreateTexture(UnlockFile("files/spaz/printstream.alphaGames", FileKeys["printstream"]), "dxt1"),
		[3] = dxCreateTexture(UnlockFile("files/spaz/abstract.alphaGames", FileKeys["abstract"]), "dxt1"),
		[4] = dxCreateTexture(UnlockFile("files/spaz/stratched.alphaGames", FileKeys["stratched"]), "dxt1"),
	},
	--[[[4] = {
...
function attachToBoneEX(sizeName, sideId, objectElement, pedElement, boneId, posX, posY, posZ, rotX, rotY, rotZ)
	...
	exports.a_boneattach:attachElementToBone(objectElement, pedElement, boneId, posX * multiplier, posY * multiplier, posZ * multiplier, rotX, rotY, rotZ)
end
