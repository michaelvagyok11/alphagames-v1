...
function processVehiclePreview(vehicle, x, y, w, h, damageView)
	...
	vehicleData = {
		mainVehicle = vehicle,
		vehicleElement = createVehicle(getElementModel(vehicle) or 0, cameraPosX, cameraPosY, cameraPosZ, 0, 0, 0),
		elementRadius = 0,
...
function setSkinProjection(x, y, w, h, skinAlpha)
	...
	if skinAlpha and skinAlpha >= 0 and skinAlpha <= 255 then
		...
		setPedAnimation(skinData.pedElement, "ped", "WOMAN_walknorm")
