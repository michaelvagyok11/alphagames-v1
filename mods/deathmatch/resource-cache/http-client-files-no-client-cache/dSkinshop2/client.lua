...
function renderGenderSelect()
    ...
    if genderPanelState then
        ...
        -- dxDrawRectangle(genderpanelX, genderpanelY, genderpanelW, genderpanelH, panelColors.background)
        -- dxDrawRectangle(genderpanelX, genderpanelY, genderpanelW, headerHeight, panelColors.header)
        -- ** text
        -- dxDrawText(panelTexts.main, genderpanelX + respc(5), genderpanelY, genderpanelX + genderpanelW, genderpanelY + genderpanelH - headerHeight, fontColors.main, 1, panelFont)
        -- dxDrawText("X", genderpanelX + respc(345), genderpanelY, genderpanelX + genderpanelW, genderpanelY + genderpanelH - headerHeight, bezarColor, 1, panelFont)
        ...
        dxDrawRectangle(genderbuttonX + respc(7) + genderbuttonW + respc(-95), genderbuttonY + genderpanelH - genderbuttonH - respc(45), genderbuttonW, genderbuttonH, tocolor(65, 65, 65))
        if isMouseInPosition(genderbuttonX + respc(7) + genderbuttonW + respc(-92), genderbuttonY + genderpanelH - genderbuttonH - respc(45), genderbuttonW, genderbuttonH) then
            dxDrawRectangle(genderbuttonX + respc(7) + genderbuttonW + respc(-93), genderbuttonY + genderpanelH - genderbuttonH - respc(46), genderbuttonW, genderbuttonH, tocolor(65, 65, 65))
        else
            dxDrawRectangle(genderbuttonX + respc(7) + genderbuttonW + respc(-93), genderbuttonY + genderpanelH - genderbuttonH - respc(46), genderbuttonW, genderbuttonH, tocolor(40, 40, 40))
        end
        dxDrawText("Férfi skinek", genderpanelX + respc(70), genderpanelY + headerHeight + respc(27), genderpanelX + genderpanelW, genderpanelY + genderpanelH - headerHeight, tocolor(200, 200, 200), 1, panelFont, "left", "center")
