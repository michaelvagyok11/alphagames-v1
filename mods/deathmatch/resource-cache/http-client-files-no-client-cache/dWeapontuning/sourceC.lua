local availablePaintjobs = {
	...
	[27] = { 
		[1] = dxCreateTexture("files/spaz/1.png", "dxt1"),
		[2] = dxCreateTexture("files/spaz/2.png", "dxt1"),
		[3] = dxCreateTexture("files/spaz/3.png", "dxt1"),
		[4] = dxCreateTexture("files/spaz/4.png", "dxt1"),
	}
	--[[[4] = {
