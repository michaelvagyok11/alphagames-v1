...
local bunnySizeX = respc(500)

local bunnySizeY = respc(372)

local bunnyPosnX = basePosnX - bunnySizeX / 2

local bunnyPosnY = basePosnY + respc(102)
...
local earsRotation = 25

local earSizeX = respc(256)

local earSizeY = respc(256)
...
function renderTheBunny()
	...
	dxDrawImage(bunnyPosnX, bunnyPosnY, bunnySizeX, bunnySizeY, TextureElements["body"], -headRotation / 4, 0, 0, derivedColor)
	...
	if earsInterpolation then
		...
		if earsInterpolation[2] then
			...
			local elapsedFraction = (frameTime - earsInterpolation[1]) / 750



			earsRotation = interpolateBetween(30, 0, 0, 15, 0, 0, elapsedFraction, "InOutQuad")
			...
			earsRotation = interpolateBetween(15, 0, 0, 30, 0, 0, elapsedFraction, "InOutQuad")
	...
	leftEarX = leftEarX - earSizeX / 2

	leftEarY = leftEarY - earSizeY / 2



	dxDrawImage(leftEarX - shadowOffset, leftEarY + shadowOffset, earSizeX, earSizeY, TextureElements["shadow_ear"], headRotation + earsRotation, 0, 0, derivedColor)

	dxDrawImage(leftEarX, leftEarY, earSizeX, earSizeY, TextureElements["ear"], headRotation + earsRotation, 0, 0, derivedColor)
	...
	rightEarX = rightEarX - earSizeX / 2

	rightEarY = rightEarY - earSizeY / 2



	dxDrawImage(rightEarX + earSizeX - shadowOffset, rightEarY - shadowOffset / 2, -earSizeX, earSizeY, TextureElements["shadow_ear"], -(earsRotation - headRotation), 0, 0, derivedColor)

	dxDrawImage(rightEarX + earSizeX, rightEarY, -earSizeX, earSizeY, TextureElements["ear"], -(earsRotation - headRotation), 0, 0, derivedColor)
