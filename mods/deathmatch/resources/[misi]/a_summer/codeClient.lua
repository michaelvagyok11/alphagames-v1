...
function onRender()
	...
	dxDrawImage(startX + sizeX / 2 - respc(32), startY - respc(0) + respc(12), respc(64), respc(64), "files/img/beach-ball.png", rotation, 0, 0, tocolor(255, 255, 255, a))
	dxDrawText("alpha", startX + sizeX / 2 - respc(42), startY - respc(0) + respc(32), _, _, tocolor(254, 217, 107, a), 1, poppinsBoldBig, "right", "center")
	...
	dxDrawText("Summer", startX + sizeX / 2 + respc(42), startY - respc(0) + respc(32), _, _, tocolor(254, 217, 107, a), 1, poppinsBoldBig, "left", "center")
	...
	if isMouseInPosition(startX + respc(50), startY + sizeY - respc(65), sizeX - respc(100), respc(25)) then
		dxDrawRectangle(startX + respc(50), startY + sizeY - respc(65), sizeX - respc(100), respc(25), tocolor(254, 217, 107, a * 0.75))
	else
		dxDrawRectangle(startX + respc(50), startY + sizeY - respc(65), sizeX - respc(100), respc(25), tocolor(254, 217, 107, a * 0.5))
	end
	...
	dxDrawText("Kellemes maradék nyarat kíván az alphaGames csapata!", startX + sizeX / 2, startY + sizeY - respc(15), _, _, tocolor(150, 150, 150, a), 1, poppinsLighSmall, "center", "center")
end
...
function sendDataToClient(source, type)
	if source and isElement(source) and source == localPlayer and type then
		if type == "success" then
			exports.a_interface:makeNotification(1, "Sikeresen begyűjtötted a nyári ajándékodat. Leghamarabb 12 óra múlva tudsz újra ajándékot kérni.")
			removeEventHandler("onClientRender", root, onRender)
			panelOpened = false
