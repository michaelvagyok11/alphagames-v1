...
function onStart()
    ...
    setElementData(easterEventPed, "a.Pedname", "Patrícia #FED96B(Summer event)")
...
function giveGiftToPlayer(source)
    if isElement(source) and client and client == source then
        ...
        if randomGift > 1 and randomGift < 50 then
            -- ** item
            exports.a_inventory:giveItem(source, 58, 1, false, false, false, false, "alphagames.net", false)
            outputChatBox("#FED96B[alphaGames - Summer Event]: #FFFFFFAz ajándékod egy #FED96BStrandlabda#ffffff! Megtalálod az inventorydban.", source, 255, 255, 255, true)
        elseif randomGift >= 50 and randomGift <= 75 then
            ...
            outputChatBox("#FED96B[alphaGames - Summer Event]: #FFFFFFAz ajándékod #F1C176" .. giftAmount .. " tapasztalatpont.", source, 255, 255, 255, true)
        elseif randomGift > 75 and randomGift <= 85 then
            ...
            outputChatBox("#FED96B[alphaGames - Summer Event]: #FFFFFFAz ajándékod #8FC3E4" .. giftAmount .. " prémiumpont.", source, 255, 255, 255, true)
        else
            outputChatBox("#FED96B[alphaGames - Summer Event]: #FFFFFFAz ajándékodat #F1C176Patrícia #FFFFFFinkább felajánlotta jótékony célokra. Gyere vissza később, hátha szerencsével jársz!", source, 255, 255, 255, true)
        end
    end
end
