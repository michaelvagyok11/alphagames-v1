...
addEventHandler("onClientResourceStart", getResourceRootElement(),
    function()
        interiorTexture = dxCreateTexture(":aShootingrange/files/img/exit.png", "argb")
...
function renderInteriorsPanel()
    ...
    -- ** innerOuterColShape:)
    dxDrawText("Belépéshez használd az E betűt.", panelX, panelY, panelW + panelX, panelH + panelY - respc(10), tocolor(200, 200, 200, panelAlpha), 1, RobotoCondensed, "center", "bottom")
end
