            ...
            if getElementData(source, "a.HPTeam") == 1 then
                for i, v in ipairs(getElementsByType("player")) do 
                    if getElementData(v, "a.HPTeam") == 1 then
                        outputChatBox("#E48F8F[FIGYELEM]: #FFFFFFIsmeretlen személy lépett be egy épületbe. #E48F8F(" .. interiorTable.name .. ")", v, 255, 255, 255, true)
                    end
                end
            end
    ...
    function(activeInterior)
        ...
        if interiorTable then
            if getElementData(source, "a.HPTeam") == 1 then
                for i, v in ipairs(getElementsByType("player")) do 
                    if getElementData(v, "a.HPTeam") == 1 then
                        outputChatBox("#E48F8F[FIGYELEM]: #FFFFFFIsmeretlen személy hagyott el egy épületet. #E48F8F(" .. interiorTable.name .. ")", v, 255, 255, 255, true)
                    end
                end
            end
